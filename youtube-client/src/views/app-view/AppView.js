...
export default class AppView {
  ...
  render() {
    ...
    document.querySelector('.clips-wrap').insertAdjacentHTML('afterEnd', '<div class="buttons-wrap"><button class="button-page prev-page"><span class="fas fa-caret-left"></span></button><div class="current-page"></div><button class="button-page next-page"><span class="fas fa-caret-right"></span></button></div>');
